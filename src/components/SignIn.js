  ...
  const handleClick = () => {
    signInWithPopup(auth, provider)
      ...
      .catch((error) => {
        ...
        // You can provide user-friendly feedback here if needed
      });
  };
      ...
      {!value && (
        <div className='w-full h-full flex justify-center items-center'>
          <Card
            ...
            style={{
              backgroundImage:
                'url("https://images.unsplash.com/photo-1701483652511-7a419837eedb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZGF5JTIwc2NlbmV8ZW58MHx8MHx8fDA%3D")',
